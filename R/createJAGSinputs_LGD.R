...
createJAGSinputs_LGD = function(dabom_list = NULL) {
  ...
  dirich_vecs = list(main_dirch_vec = createDirichletVector(n_branch_list$n.pops.main,
                     ...
                     wal_dirch_vec = createDirichletVector(n_branch_list$n.pops.Wallowa[1],
                                                           table(init_mats$a_Wal)),
                     walUp_dirch_vec = createDirichletVector(n_branch_list$n.pops.Wallowa[2],
                                                             table(init_mats$a_WalUp)),
                     ...
                     sfs_dirch_vec = createDirichletVector(n_branch_list$n.pops.SFS[1],
                                                           table(init_mats$a_SFS)),
                     ess_dirch_vec = createDirichletVector(n_branch_list$n.pops.SFS[2],
                                                           table(init_mats$a_ESS)),
