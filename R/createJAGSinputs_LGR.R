#' @title Prep DABOM JAGS inputs - LGR
#'
...
#' @export
#' @return NULL
#' @examples createJAGSinputs_LGR()

createJAGSinputs_LGR = function(filter_ch = NULL,
                                parent_child = NULL,
                                configuration = NULL,
                                fish_origin = NULL) {
  ...
  init_val_func = setInitialValues_LGR(filter_ch = filter_ch,
                                       parent_child = parent_child,
                                       configuration = configuration)
