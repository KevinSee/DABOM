#' @title Prep DABOM JAGS inputs - PRA
#'
#' @description Construct all the necessary inputs to the DABOM JAGS model for PRA Returns a named list that can be passed directly to JAGS.
#'
#' @author Kevin See
#'
...
createJAGSinputs_PRA = function(dabom_list = NULL) {
  ...
  init_val_func = setInitialValues_PRA(dabom_list)
