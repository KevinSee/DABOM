#' @title Prep DABOM capture histories - LGR
#'
...
#' @export
#' @return NULL
#' @examples createDABOMcapHist_LGR()

createDABOMcapHist_LGR = function(filter_ch = NULL,
                                  parent_child = NULL,
                                  configuration = NULL,
                                  split_matrices = F) {
  ...
  pc_nodes = PITcleanr::addParentChildNodes_LGR(parent_child,
                                                configuration)
