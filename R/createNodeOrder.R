...
#' @author Kevin See
#'
#' @param valid_paths a dataframe created by the \code{getValidPaths} function in the \code{PITcleanr} package.
#'
#' @param configuration a configuration file built by \code{buildConfig} in the \code{PITcleanr} package.
#'
#' @param parent_child is a data frame created by \code{createParentChildDf} in the \code{PITcleanr} package.
#'
#' @param site_df a data frame created by one of the \code{write___NodeNetwork} functions in the \code{PITcleanr} package.
#'
...
createNodeOrder = function(valid_paths = NULL,
  ...
  if(is.null(configuration)) configuration = PITcleanr::buildConfig()
